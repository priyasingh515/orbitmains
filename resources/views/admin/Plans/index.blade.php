    ...
    <div class="container-fluid my-2">
        <div class="row mb-2">
            ...
            <div class="col-sm-6 text-right">
                <a href="{{route('plan.create')}}" class="btn btn-primary">Add Plans</a>
            </div>
        </div>
    </div>
    <!-- /.container-fluid -->
                ...
                <table class="table table-hover text-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> {{$plan->description_2}}</td>
                            <td> {{$plan->description_3}}</td>
                            <td> {{$plan->description_4}}</td>
                            <td> {{$plan->state}}</td>
                            <td>
                                ...
                                <a href="{{ route('plan.delete', $plan->id) }}" class="text-danger" onclick="return confirm('Are you sure you want to delete this?');">

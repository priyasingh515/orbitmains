                ...
                <table class="table table-hover text-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <img src="{{url('public/admin/sliders',$slider->image)}}" alt="slider" height="100" width="100">
                            </td>
                            <td>
                                ...
                                <a href="{{ route('slider.delete', $slider->id) }}" class="text-danger" onclick="return confirm('Are you sure you want to delete this?');">

                            ...
                            <div class="mb-3">
                                ...
                                <select name="paper_type" id="paper_type" class="form-control">
                                    ...
                                    @foreach ($paperTypes as $paper)
                                        <option value="{{ $paper->id }}" {{ old('paper_type', $mainsData->paper_type ?? '') == $paper->id ? 'selected' : '' }}>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select name="subject_type" id="subject_type" class="form-control">
                                    <option value="">Select</option>
                                    @foreach ($subjectType as $subject)
                                      <option value="{{$subject->id}}" {{ old('subject_type', $mainsData->subject_type ?? '') == $subject->id ? 'selected' : '' }}>{{$subject->subject_name}}</option>
                                    @endforeach
                                </select>  
                             </div>
                        </div>
